...
class WideResNet(nn.Module):
    ...
    def forward(self, x, only_fc=False, only_feat=False, **kwargs):
        ...
        result_dict = {'rot':rot, 'logits':output, 'feat':out}
        return result_dict
...
def rot_wrn_28_2(pretrained=False, pretrained_path=None, **kwargs):
...
def rot_wrn_28_8(pretrained=False, pretrained_path=None, **kwargs):
